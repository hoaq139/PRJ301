                ...
                <table class="fl-table">
                    <thead>
                        <tr>
                            ...
                            <td><input type="text" value="${s.title}" name="title" required=""/></td>
                        </tr>
                    </thead>
                    <tbody>
                    <input type="hidden" name="id" value="${s.id}">
                        ...
                        <tr>
                            ...
                            <td><input value="${s.shortDes}" type="text" name="shortdes" required=""/></td>
                        </tr>
                        <tr>
                            <td style="color: #ffffff; background: #324960; width: 10rem;">Description</td>
                            <td><input value="${s.description}" type="text" name="description" required=""/></td>
                        </tr>
                        <tr>
